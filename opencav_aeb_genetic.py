...
def bridge(sid, data):
    ...
    if data:
        ...
        #     opencav_1.handbrake_command = 0 # [0, 1]
        commandInfo = commandData[0]
        
        opencav_1.throttle_command = -1 + float(commandInfo['commands'][(commandInfo['timestep'] * 3) + 0])
        opencav_1.steering_command = -1 + float(commandInfo['commands'][(commandInfo['timestep'] * 3) + 1])
        opencav_1.brake_command = int(commandInfo['commands'][(commandInfo['timestep'] * 3) + 2])
